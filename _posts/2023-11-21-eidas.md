...
_This article, like ["Echoes from History: Designing Self-Sovereign Identity with Care"](https://www.lifewithalacrity.com/article/echoes-history/), is drawn from a book I have in process called FOREMEMBRANCE, which chronicles how identity was abused in WWII and how those dangers linger to the present day._
...
In order to protect our human rights, we need to ensure that modern-day information systems protect our data in meaningful ways. As we learned [through the lessons of Lentz and Carmille](https://www.lifewithalacrity.com/article/echoes-history/), there are two paths before us.
