...
So I've been trying to figure out how to cover some of the other things that I am up to without loosing my readers here, so decided to a create a new blog for my shorter and more transitory thoughts: [Christopher Allen's Ephemera Blog](https://ephemera.lifewithalacrity.com/). So far I have posted:
...
The RSS feed for this blog is here <a href="http://feeds.feedburner.com/ChristopherAllensEphemeraBlog"><img style=" margin-left:10px" src="../assets/images/feed-icon16x16.png" alt="Circle of Hands"/></a>.
